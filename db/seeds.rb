...
Listing.create(title: "Crockpot", description: "This is a crockpot that i do not want please come pick it up ASAP", category: "Kitchen", claimed: true, owner_id: 1, recipient_id: 2)
Listing.create(title: "Treadmill", description: "I dont use this treadmill anymore! Would love it to go to a good home.", category: "Exercise equipment", claimed: false, owner_id: 2)
Listing.create(title: "Dishes", description: "New dish set, never used.", category: "kitchen", claimed: true, owner_id: 2, recipient_id:1)
Listing.create(title: "Clothes", description: "Womens clothes sizes small-medium, 6-8, lightly used", category: "Clothing", claimed: false, owner_id: 2)
Listing.create(title: "Clothes", description: "Mens clothes size medium.", category: "Clothing", claimed: true, owner_id: 3, recipient_id: 4)
